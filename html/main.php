...
<form method="post" action="../script/functions.php">
    <div class="form-group">
        ...
        <input class="form-control" type="text" <?php echo 'value= "'.$_SESSION['user'].'"'; ?> name="name">
        <label for="posted" class="font-weight-bold">Post here your text</label>
        <textarea name="posted" id="posted1" cols="58" rows="10"></textarea><br>
        <button class="btn btn-primary mt-3" name="submit" type="submit">Send</button>
    </div>
</form>
</div>
</div>
